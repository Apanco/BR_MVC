<main class="contenedor seccion contenido-centrado">
        <h1 class="espacio-arriba">Nuestro blog</h1>
        <!-- Entrada 1 -->
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada">
                    ...
                    <p>Escrito el <span>13/01/2024</span> por <span>David Apanco</span></p>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img src="build/img/blog3.jpg" alt="Imagen blog 1" loading="lazy">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="entrada">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <img src="build/img/blog4.jpg" alt="Imagen blog 1" loading="lazy">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="entrada">
